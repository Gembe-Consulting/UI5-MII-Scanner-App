sap.ui.define([
	...
	return Controller.extend("test.playground.View1", {
		onCallExternalAppInNewFrame: function(oEvent) {
			var sStorageUnitNumber = this.byId("storageUnitNumber")
				.getValue(),
				sOrderNumber = this.byId("orderNumber")
				.getValue(),
				sUnit = this.byId("unitOfMeasure")
				.getValue(),
				sStorageLocation = this.byId("storageLocation")
				.getValue(),
				sNavigation = this.byId("navigation")
				.getValue();
